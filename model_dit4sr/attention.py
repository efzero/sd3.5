...
#                 print(hidden_states.shape, hidden_states_control.shape, "hidden states hidden states control shape")
...
#             hidden_states = module(hidden_states)
#             if i == 1:
#                 hidden_states_, hidden_states_control_org = hidden_states.chunk(2, dim=1)
#                 B, N, C = hidden_states_.shape
#                 h = w = int(np.sqrt(N))
#                 assert h * w == N
#                 hidden_states_control = hidden_states_control_org.reshape(B, h, w, C).permute(0, 3, 1, 2)
#                 hidden_states_control = self.control_conv(hidden_states_control)
...
# #                     hidden_states_control = self.control_conv(hidden_states_control)
# #                     hidden_states_control = hidden_states_control.reshape(B, C, N).permute(0, 2, 1)
# # #                     hidden_states_ = hidden_states_ + 1.2 * hidden_states_control # what is this 1.2 here?
# #                     hidden_states_ = hidden_states_ + 0.5 * hidden_states_control # what is this 1.2 here?
# #                     hidden_states = torch.cat([hidden_states_, hidden_states_control_org], dim=1)
